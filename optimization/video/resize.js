...
console.log(cloudinary.url('hat', { crop: 'scale', width: 900, format: 'mp4', resource_type: 'video' }))
console.log(cloudinary.url('hat', { crop: 'scale', height: 600, format: 'mp4', resource_type: 'video' }))
//skew
console.log(cloudinary.url('hat', { crop: 'scale', width: 900, height: 600, format: 'mp4', resource_type: 'video' }))
// correct skew with fit, limit
console.log('-----')
console.log(cloudinary.url('hat', { crop: 'fit', width: 900, height: 600, format: 'mp4', resource_type: 'video' }))
console.log(cloudinary.url('hat', { crop: 'limit', width: 900, height: 600, format: 'mp4', resource_type: 'video' }))

// change the apsect ratio and pad
console.log('-----')
console.log(cloudinary.url('hat', { crop: 'pad', width: 600, height: 900, background: 'auto', format: 'mp4', resource_type: 'video' }))
console.log(cloudinary.url('hat', { crop: 'lpad', width: 600, height: 900, background: 'auto', format: 'mp4', resource_type: 'video' }))
